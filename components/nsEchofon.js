...
Echofon.prototype = {
  ...
  destroySavedSearch: function(param) {
    ...
    var tc = new TwitterClient(account, this);
    tc.ssId = param.id;
    tc.post("saved_searches.destroy." + param.id, {}, "saved_searches_destroy");
  },
  ...
  undoRetweet: function(msg) {
    var account = EchofonAccountManager.instance().get();
    var req = new TwitterClient(account, this);
    req.post("statuses.destroy." + msg.id, {}, "statuses_undo_retweet");
  },
  ...
  blockUser: function(param) {
    if (param.type == "Block") {
      ...
      this.post("report_spam", {user_id:param.user_id});
    }
  },
